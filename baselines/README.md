...
Baseline results on PPIE: The following are the results generated by SBLLM on five different LLMs. 

|                | **Language** | **Baseline Generated Code (Includes CodeLlama-13b-Instruct-hf, CodeLlama-34b-Instruct-hf, Gemini-2.5-flash, GPT-3.5-turbo-0125 and DeepSeek-V3.2-Exp)** |
|:--------------:|:------------:|:-----------------------------------------------------------------------:|
